...
const statusCopy = {
  pending: { title: 'Booking Request Submitted', message: 'Waiting for confirmation' },
  confirmed: { title: 'Booking Confirmed', message: 'Your appointment has been confirmed.' },
}
